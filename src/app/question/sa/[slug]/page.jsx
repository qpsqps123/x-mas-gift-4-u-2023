...
import classes from "@/containers/SaQuestionTemplate/SaQuestionTemplate.module.scss";
...
export default function SaQuestionTemplate({ params }) {
    ...
    if (
      ...
      setTimeout(() => {
        if (pathname === "/question/sa/4") {
          ...
          router.replace(`/question/sa/${(currentQuestionNum + 1).toString()}`);
        }
      }, 3000);
    } else if (
      inputValue !== answerList[currentQuestionNum] &&
